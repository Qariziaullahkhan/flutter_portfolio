          ...
          children: [
            Row(
              children: [
                ...
                const Spacer(),
                Text('${(value*100).toInt().toString()}%',style:const TextStyle(color: Colors.white),),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        AnimatedLinearProgressIndicator(percentage: 0.55, title: 'Sqlite',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'Responsive Design',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Clean Architecture',image: 'assets/icons/flutter.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'Bloc',image: 'assets/icons/bloc.png'),
        AnimatedLinearProgressIndicator(percentage: 0.5, title: 'Getx',image: 'assets/icons/dart.png'),
                AnimatedLinearProgressIndicator(percentage: 0.8, title: 'Providers',image: 'assets/icons/dart.png'),
